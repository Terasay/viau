    ...
    "lines": [
        {
            ...
            "technologies": [
                ...
                {"id": "blast_furnaces_1", "name": "Доменные печи", "year": 1520, "requires": ["blacksmithing"]},
                {"id": "iron_ore_mining", "name": "Добыча железной руды", "year": 1520, "requires": ["blacksmithing"]},
                {"id": "cast_iron", "name": "Чугун", "year": 1550, "requires": ["blast_furnaces_1", "iron_ore_mining"]},
                {"id": "wrought_iron", "name": "Кованое железо", "year": 1550, "requires": ["blast_furnaces_1", "iron_ore_mining"]},
                
                # Развитие (1600-1750)
                {"id": "charcoal_fuel", "name": "Древесный уголь", "year": 1600, "requires": ["cast_iron", "wrought_iron"]},
                {"id": "foundry_production", "name": "Литейное производство", "year": 1630, "requires": ["cast_iron"]},
                {"id": "coal_mining", "name": "Добыча каменного угля", "year": 1650, "requires": ["charcoal_fuel"]},
                {"id": "coking_coal", "name": "Коксование угля", "year": 1680, "requires": ["coal_mining"]},
                {"id": "coke_blast_furnaces", "name": "Коксовые доменные печи", "year": 1710, "requires": ["coking_coal", "foundry_production"]},
                {"id": "rolling_mills", "name": "Прокатные станы", "year": 1730, "requires": ["coke_blast_furnaces"]},
                {"id": "puddling", "name": "Пудлингование", "year": 1750, "requires": ["rolling_mills", "wrought_iron"]},
                
                # Промышленная революция (1750-1860)
                {"id": "crucible_steel", "name": "Тигельная сталь", "year": 1780, "requires": ["puddling"]},
                {"id": "hot_blast", "name": "Горячее дутье", "year": 1810, "requires": ["coke_blast_furnaces"]},
                {"id": "bessemer_process", "name": "Бессемеровский процесс", "year": 1850, "requires": ["crucible_steel", "hot_blast"]},
                
                # Сталелитейная эпоха (1860-1900)
                {"id": "mass_steel_production", "name": "Массовое производство стали", "year": 1870, "requires": ["bessemer_process"]},
                {"id": "open_hearth", "name": "Мартеновский процесс", "year": 1880, "requires": ["mass_steel_production"]},
                {"id": "alloy_steel", "name": "Легированная сталь", "year": 1890, "requires": ["open_hearth"]},
                {"id": "electrometallurgy", "name": "Электрометаллургия", "year": 1900, "requires": ["alloy_steel", "electric_generators"]},
            ]
        },
        {
            "id": "textiles",
