    ...
    "lines": [
        {
            ...
            "technologies": [
                # Начальные корабли - две независимые ветви
                {"id": "caravels", "name": "Каравеллы", "year": 1500, "requires": []},
                {"id": "galleys", "name": "Галеры", "year": 1500, "requires": []},
                
                # Парусная ветвь (от каравелл)
                {"id": "carracks", "name": "Каракки", "year": 1520, "requires": ["caravels", "improved_sails"]},
                {"id": "galleons_1", "name": "Галеоны I", "year": 1540, "requires": ["carracks", "gun_ports"]},
                
                # Гребная ветвь (от галер)
                {"id": "improved_galleys", "name": "Улучшенные галеры", "year": 1525, "requires": ["galleys", "blacksmithing"]},
                {"id": "galleasses", "name": "Галеасы", "year": 1545, "requires": ["improved_galleys", "broadside_guns"]},
                
                # Слияние ветвей
                {"id": "galleons_2", "name": "Галеоны II", "year": 1565, "requires": ["galleons_1", "multi_tier_armament"]},
                {"id": "war_galleons", "name": "Военные галеоны", "year": 1585, "requires": ["galleons_2", "heavy_naval_guns"]},
                
                # Линейные корабли (основная ветвь)
                {"id": "ships_of_line_1", "name": "Линейные корабли I", "year": 1605, "requires": ["war_galleons", "caliber_standardization_navy"]},
                {"id": "multi_deck_ships", "name": "Многопалубные корабли", "year": 1625, "requires": ["ships_of_line_1", "shipyards"]},
                {"id": "ships_of_line_2", "name": "Линейные корабли II", "year": 1645, "requires": ["multi_deck_ships", "foundry_production"]},
                
                # Фрегаты (параллельная ветвь лёгких кораблей)
                {"id": "frigates_1", "name": "Фрегаты I", "year": 1665, "requires": ["ships_of_line_1", "improved_carriages_navy"]},
                {"id": "corvettes", "name": "Корветы", "year": 1695, "requires": ["frigates_1", "coke_blast_furnaces"]},
                
                # Продолжение линейных кораблей
                {"id": "ships_of_line_3", "name": "Линейные корабли III", "year": 1680, "requires": ["ships_of_line_2", "naval_artillery_1"]},
                {"id": "ships_of_line_4", "name": "Линейные корабли IV", "year": 1715, "requires": ["ships_of_line_3", "chronometers_1"]},
                
                # Слияние фрегатов и линкоров
                {"id": "frigates_2", "name": "Фрегаты II", "year": 1730, "requires": ["corvettes", "rolling_mills_1"]},
                {"id": "ships_of_line_5", "name": "Линейные корабли V", "year": 1745, "requires": ["ships_of_line_4", "naval_artillery_3"]},
                
                # Медная обшивка - отдельная технология
                {"id": "copper_plating", "name": "Медная обшивка днища", "year": 1765, "requires": ["ships_of_line_5", "quality_steel"]},
                
                # Финальные парусные корабли (две параллельные ветви)
                {"id": "fast_frigates", "name": "Быстроходные фрегаты", "year": 1780, "requires": ["frigates_2", "copper_plating"]},
                {"id": "ships_of_line_6", "name": "Линейные корабли VI", "year": 1795, "requires": ["copper_plating", "carronades"]},
                
                # Переход к паровым судам
                {"id": "experimental_steamships", "name": "Экспериментальные паровые суда", "year": 1810, "requires": ["industrial_steam_power", "large_shipyards"]},
                {"id": "paddle_steamers", "name": "Паровые колесные суда", "year": 1820, "requires": ["experimental_steamships", "hot_blast"]},
                {"id": "steam_frigates_1", "name": "Паровые фрегаты I", "year": 1835, "requires": ["paddle_steamers", "efficient_steam_engines"]},
                
                # Винтовые корабли
                {"id": "screw_ships", "name": "Винтовые корабли", "year": 1845, "requires": ["steam_frigates_1", "precision_tools"]},
                {"id": "steam_ships_of_line", "name": "Паровые линкоры", "year": 1855, "requires": ["screw_ships", "breech_loading_naval_guns"]},
                
                # Броненосцы (основная ветвь)
                {"id": "ironclads_1", "name": "Броненосцы I", "year": 1860, "requires": ["steam_ships_of_line", "bessemer_process"]},
                ...
                # Крейсеры (параллельная ветвь)
                {"id": "cruisers_1", "name": "Крейсеры I", "year": 1880, "requires": ["ironclads_1", "compound_engines"]},
                {"id": "cruisers_2", "name": "Крейсеры II", "year": 1890, "requires": ["cruisers_1", "alloy_steel"]},
                
                # Современные корабли
                {"id": "modern_battleships", "name": "Современные броненосцы", "year": 1885, "requires": ["ironclads_2", "heavy_naval_artillery"]},
                {"id": "pre_dreadnoughts", "name": "Эскадренные броненосцы", "year": 1895, "requires": ["modern_battleships", "high_quality_steel"]},
                {"id": "dreadnoughts", "name": "Дредноуты", "year": 1900, "requires": ["pre_dreadnoughts", "modern_naval_artillery", "industrial_turbines"]},
            ]
        },
        {
            "id": "naval_weapons",
            ...
            "technologies": [
                # Начальное вооружение - две независимые ветви
                {"id": "falconets", "name": "Фальконеты", "year": 1500, "requires": []},
                {"id": "naval_bombards", "name": "Морские бомбарды", "year": 1500, "requires": []},
                
                # Лёгкие пушки (от фальконетов)
                {"id": "broadside_guns", "name": "Бортовые пушки", "year": 1515, "requires": ["falconets", "blacksmithing"]},
                
                # Тяжёлые пушки (от бомбард)
                {"id": "culverins", "name": "Кулеврины", "year": 1520, "requires": ["naval_bombards", "bronze_cannons"]},
                
                # Слияние в улучшенные пушки
                {"id": "improved_naval_guns", "name": "Улучшенные морские пушки", "year": 1535, "requires": ["broadside_guns", "culverins"]},
                
                # Конструкционные улучшения (отдельная ветвь)
                {"id": "gun_ports", "name": "Пушечные порты", "year": 1550, "requires": ["improved_naval_guns", "carracks"]},
                {"id": "multi_tier_armament", "name": "Многоярусное вооружение", "year": 1570, "requires": ["gun_ports", "wrought_iron"]},
                {"id": "heavy_naval_guns", "name": "Тяжелые морские пушки", "year": 1585, "requires": ["multi_tier_armament", "cast_iron"]},
                
                # Стандартизация (отдельная ветвь)
                {"id": "caliber_standardization_navy", "name": "Стандартизация калибров", "year": 1600, "requires": ["heavy_naval_guns", "gun_standardization"]},
                {"id": "improved_carriages_navy", "name": "Улучшенные лафеты", "year": 1615, "requires": ["caliber_standardization_navy", "quality_craftsmanship"]},
                
                # Снаряды (параллельные ветви)
                {"id": "anti_ship_shot", "name": "Противокорабельные ядра", "year": 1630, "requires": ["improved_carriages_navy", "cast_iron_casting"]},
                {"id": "incendiary_shot", "name": "Зажигательные снаряды", "year": 1645, "requires": ["anti_ship_shot", "gunpowder_production"]},
                {"id": "boarding_grapeshot", "name": "Картечь для абордажа", "year": 1660, "requires": ["anti_ship_shot", "canister_shot"]},
                
                # Дальнобойность (независимая от типа снарядов)
                {"id": "long_range_guns", "name": "Дальнобойные пушки", "year": 1675, "requires": ["improved_carriages_navy", "coking_coal"]},
                
                # Корабельная артиллерия I-II
                {"id": "naval_artillery_1", "name": "Корабельная артиллерия I", "year": 1690, "requires": ["long_range_guns", "boarding_grapeshot"]},
                {"id": "explosive_shells_navy", "name": "Разрывные снаряды", "year": 1705, "requires": ["naval_artillery_1", "explosive_shells"]},
                {"id": "naval_artillery_2", "name": "Корабельная артиллерия II", "year": 1720, "requires": ["explosive_shells_navy", "rolling_mills_1"]},
                
                # Карронады и длинные пушки (две параллельные ветви)
                {"id": "carronades", "name": "Карронады", "year": 1735, "requires": ["naval_artillery_2", "puddling"]},
                {"id": "long_guns", "name": "Длинные пушки", "year": 1765, "requires": ["naval_artillery_2", "quality_steel"]},
                
                # Артиллерия III-IV
                {"id": "naval_artillery_3", "name": "Корабельная артиллерия III", "year": 1750, "requires": ["carronades", "steel_barrels"]},
                {"id": "improved_rate_of_fire", "name": "Улучшенная скорострельность", "year": 1780, "requires": ["long_guns", "iron_rolling"]},
                {"id": "naval_artillery_4", "name": "Корабельная артиллерия IV", "year": 1795, "requires": ["naval_artillery_3", "improved_rate_of_fire"]},
                
                # Ракеты (отдельная ветвь)
                {"id": "naval_rockets", "name": "Ракетное оружие для флота", "year": 1810, "requires": ["rockets", "naval_artillery_4"]},
                
                # Нарезные орудия
                {"id": "rifled_naval_guns_1", "name": "Нарезные морские орудия I", "year": 1820, "requires": ["rifled_artillery_1", "crucible_steel"]},
                {"id": "explosive_bombs", "name": "Разрывные бомбы", "year": 1835, "requires": ["rifled_naval_guns_1", "solvay_process"]},
                ...
                # Башенные орудия
                {"id": "turret_guns_1", "name": "Башенные орудия I", "year": 1855, "requires": ["breech_loading_naval_guns", "bessemer_process"]},
                {"id": "armor_piercing_shells", "name": "Бронебойные снаряды", "year": 1865, "requires": ["turret_guns_1", "mass_steel_production"]},
                {"id": "turret_guns_2", "name": "Башенные орудия II", "year": 1870, "requires": ["armor_piercing_shells", "hydraulic_recoil"]},
                
                # Торпеды (отдельная ветвь)
                {"id": "torpedoes", "name": "Торпеды", "year": 1875, "requires": ["dynamite", "compound_engines"]},
                {"id": "improved_torpedoes", "name": "Улучшенные торпеды", "year": 1890, "requires": ["torpedoes", "electric_generators"]},
                
                # Скорострельные орудия
                {"id": "quick_firing_naval_guns", "name": "Скорострельные морские пушки", "year": 1880, "requires": ["turret_guns_2", "quick_firing_artillery"]},
                {"id": "heavy_naval_artillery", "name": "Тяжелая корабельная артиллерия", "year": 1885, "requires": ["quick_firing_naval_guns", "high_quality_steel"]},
                {"id": "modern_naval_artillery", "name": "Современная морская артиллерия", "year": 1895, "requires": ["heavy_naval_artillery", "improved_torpedoes"]},
            ]
        },
        {
            "id": "navigation",
            ...
            "technologies": [
                # Начальная навигация - две независимые ветви
                {"id": "compass", "name": "Компас", "year": 1500, "requires": []},
                {"id": "coastal_piloting", "name": "Прибрежное лоцманство", "year": 1500, "requires": []},
                
                # Астрономическая навигация (от компаса)
                {"id": "astrolabe", "name": "Астролябия", "year": 1515, "requires": ["compass", "alchemy"]},
                {"id": "navigation_tables", "name": "Навигационные таблицы", "year": 1540, "requires": ["astrolabe", "acids"]},
                
                # Картография (от лоцманства)
                {"id": "sea_charts_1", "name": "Морские карты I", "year": 1525, "requires": ["coastal_piloting", "workshops"]},
                
                # Паруса (требует оба знания)
                {"id": "improved_sails", "name": "Улучшенные паруса", "year": 1555, "requires": ["navigation_tables", "sea_charts_1"]},
                {"id": "sea_charts_2", "name": "Морские карты II", "year": 1575, "requires": ["improved_sails", "experimental_chemistry"]},
                
                # Звёздная навигация
                {"id": "star_navigation", "name": "Навигация по звездам", "year": 1595, "requires": ["navigation_tables", "glass_production"]},
                
                # Измерительные инструменты (параллельные ветви)
                {"id": "log_speed", "name": "Лаг (измеритель скорости)", "year": 1615, "requires": ["sea_charts_2"]},
                {"id": "quadrant", "name": "Квадрант", "year": 1625, "requires": ["star_navigation", "quality_iron"]},
                
                # Улучшенные инструменты
                {"id": "improved_compass", "name": "Улучшенные компасы", "year": 1640, "requires": ["quadrant", "foundry_production"]},
                {"id": "sextant", "name": "Секстант", "year": 1655, "requires": ["improved_compass", "glass_production"]},
                
                # Научная навигация
                {"id": "naval_astronomy", "name": "Морская астрономия", "year": 1670, "requires": ["sextant", "basic_chemistry"]},
                {"id": "barometer", "name": "Барометр", "year": 1685, "requires": ["naval_astronomy", "vacuum_pumps"]},
                {"id": "depth_sounder", "name": "Глубиномер", "year": 1700, "requires": ["log_speed", "industrial_chemistry_1"]},
                
                # Хронометры и определение долготы
                {"id": "chronometers_1", "name": "Морские хронометры I", "year": 1715, "requires": ["barometer", "rolling_mills_1"]},
                {"id": "longitude_finding", "name": "Точное определение долготы", "year": 1730, "requires": ["chronometers_1", "naval_astronomy"]},
                {"id": "scientific_cartography", "name": "Научная картография", "year": 1745, "requires": ["longitude_finding", "industrial_chemistry_2"]},
                {"id": "chronometers_2", "name": "Морские хронометры II", "year": 1760, "requires": ["scientific_cartography", "quality_steel"]},
                
                # Сигнализация (отдельная ветвь)
                {"id": "sea_signals", "name": "Морские сигналы", "year": 1775, "requires": ["depth_sounder", "optical_telegraph"]},
                {"id": "semaphore", "name": "Семафорная связь", "year": 1790, "requires": ["sea_signals", "semaphore_communication"]},
                
                # Маяки и освещение
                {"id": "lighthouses", "name": "Морские маяки", "year": 1805, "requires": ["semaphore", "lighthouses"]},
                {"id": "precise_sea_charts", "name": "Точные морские карты", "year": 1820, "requires": ["chronometers_2", "lighthouses"]},
                
                # Научная океанография
                {"id": "hydrography", "name": "Гидрография", "year": 1835, "requires": ["precise_sea_charts", "machine_building"]},
                {"id": "steam_navigation", "name": "Паровая навигация", "year": 1850, "requires": ["hydrography", "steam_frigates_1"]},
                {"id": "oceanography", "name": "Океанография", "year": 1860, "requires": ["steam_navigation", "organic_chemistry"]},
                {"id": "ocean_currents", "name": "Морские течения", "year": 1870, "requires": ["oceanography"]},
                
                # Современная навигация
                {"id": "radio_communication_navy", "name": "Радиосвязь на море", "year": 1880, "requires": ["ocean_currents", "telephone"]},
                {"id": "modern_cartography", "name": "Современная картография", "year": 1890, "requires": ["radio_communication_navy", "undersea_cables"]},
                {"id": "electric_lighthouses", "name": "Электрическое освещение маяков", "year": 1895, "requires": ["modern_cartography", "electric_lighting"]},
                {"id": "modern_navigation_systems", "name": "Современные навигационные системы", "year": 1900, "requires": ["electric_lighthouses", "wireless_telegraph"]},
            ]
        },
        {
            "id": "naval_doctrine",
            ...
            "technologies": [
                # Начальная тактика - две независимые ветви
                ...
                # Абордажная ветвь
                {"id": "ship_discipline", "name": "Корабельная дисциплина", "year": 1520, "requires": ["boarding_tactics", "craft_guilds"]},
                {"id": "marines_1", "name": "Морская пехота I", "year": 1540, "requires": ["ship_discipline", "labor_specialization"]},
                
                # Артиллерийская ветвь
                {"id": "broadside_doctrine", "name": "Бортовой залп", "year": 1525, "requires": ["naval_gunnery", "broadside_guns"]},
                
                # Слияние в организацию флота
                {"id": "fleet_organization", "name": "Флотская организация", "year": 1545, "requires": ["broadside_doctrine", "marines_1"]},
                {"id": "squadrons", "name": "Эскадры", "year": 1565, "requires": ["fleet_organization", "galleons_1"]},
                {"id": "naval_battles", "name": "Морские сражения", "year": 1585, "requires": ["squadrons", "war_galleons"]},
                
                # Линейная тактика
                {"id": "fleet_discipline", "name": "Флотская дисциплина", "year": 1605, "requires": ["naval_battles", "production_organization"]},
                ...
                # Координация и сигналы
                {"id": "squadron_coordination", "name": "Координация эскадр", "year": 1655, "requires": ["linear_fleet_tactics_1", "sextant"]},
                {"id": "fleet_signals", "name": "Флотские сигналы", "year": 1670, "requires": ["squadron_coordination", "sea_signals"]},
                
                # Тактические манёвры (параллельные ветви)
                {"id": "line_breaking", "name": "Тактика прорыва линии", "year": 1685, "requires": ["fleet_signals"]},
                {"id": "concentrated_fire", "name": "Сосредоточение огня", "year": 1700, "requires": ["fleet_signals", "naval_artillery_1"]},
                
                # Крейсерские операции
                {"id": "cruiser_operations", "name": "Крейсерские операции", "year": 1715, "requires": ["concentrated_fire", "corvettes"]},
                {"id": "port_blockade", "name": "Блокада портов", "year": 1730, "requires": ["cruiser_operations", "frigates_2"]},
                
                # Артиллерийская тактика
                {"id": "fleet_artillery", "name": "Флотская артиллерия", "year": 1745, "requires": ["line_breaking", "naval_artillery_3"]},
                {"id": "convoy_system", "name": "Конвойная система", "year": 1760, "requires": ["port_blockade", "fleet_artillery"]},
                
                # Агрессивная тактика
                {"id": "aggressive_tactics", "name": "Агрессивная тактика", "year": 1775, "requires": ["convoy_system", "carronades"]},
                {"id": "force_concentration", "name": "Сосредоточение сил", "year": 1790, "requires": ["aggressive_tactics", "semaphore"]},
                {"id": "tactical_flexibility", "name": "Тактическая гибкость", "year": 1805, "requires": ["force_concentration", "naval_artillery_4"]},
                ...
                # Броненосная доктрина
                {"id": "ironclad_doctrine", "name": "Броненосная доктрина", "year": 1850, "requires": ["screw_maneuverability", "armor_piercing_shells"]},
                {"id": "modern_naval_warfare", "name": "Современная морская война", "year": 1860, "requires": ["ironclad_doctrine", "ironclads_1"]},
                
                # Теория морской мощи
                {"id": "ocean_fleet", "name": "Океанский флот", "year": 1870, "requires": ["modern_naval_warfare", "oceanography"]},
                {"id": "sea_power_theory", "name": "Теория морской мощи", "year": 1880, "requires": ["ocean_fleet", "cruisers_1"]},
                {"id": "command_of_sea", "name": "Командование морем", "year": 1890, "requires": ["sea_power_theory", "modern_battleships"]},
                {"id": "sea_dominance", "name": "Доминирование на море", "year": 1900, "requires": ["command_of_sea", "dreadnoughts"]},
            ]
        }
    ]
}
