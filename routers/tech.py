    ...
    "lines": [
        {
            ...
            "technologies": [
                ...
                {"id": "carracks", "name": "Каракки", "year": 1520, "requires": ["caravels", "improved_sails", "shipyards"]},
                {"id": "improved_galleys", "name": "Улучшенные галеры", "year": 1525, "requires": ["galleys", "quality_iron"]},
                {"id": "galleons_1", "name": "Галеоны I", "year": 1540, "requires": ["carracks", "gun_ports", "large_manufactories"]},
                {"id": "galleasses", "name": "Галеасы", "year": 1545, "requires": ["improved_galleys", "broadside_guns", "improved_hull_construction"]},
                {"id": "galleons_2", "name": "Галеоны II", "year": 1565, "requires": ["galleons_1", "multi_tier_armament", "dry_docks"]},
                {"id": "war_galleons", "name": "Военные галеоны", "year": 1585, "requires": ["galleons_2", "heavy_naval_guns", "naval_battles"]},
                {"id": "ships_of_line_1", "name": "Линейные корабли I", "year": 1605, "requires": ["war_galleons", "caliber_standardization_navy", "line_formation"]},
                {"id": "multi_deck_ships", "name": "Многопалубные корабли", "year": 1625, "requires": ["ships_of_line_1", "improved_hull_construction", "port_cranes"]},
                {"id": "ships_of_line_2", "name": "Линейные корабли II", "year": 1645, "requires": ["multi_deck_ships", "linear_fleet_tactics_1", "coke_blast_furnaces"]},
                {"id": "frigates_1", "name": "Фрегаты I", "year": 1665, "requires": ["ships_of_line_2", "improved_masts", "fleet_signals"]},
                {"id": "ships_of_line_3", "name": "Линейные корабли III", "year": 1680, "requires": ["frigates_1", "naval_artillery_1", "deep_water_ports"]},
                {"id": "corvettes", "name": "Корветы", "year": 1695, "requires": ["frigates_1", "concentrated_fire", "rolling_mills_1"]},
                {"id": "ships_of_line_4", "name": "Линейные корабли IV", "year": 1715, "requires": ["ships_of_line_3", "chronometers_1", "puddling"]},
                {"id": "frigates_2", "name": "Фрегаты II", "year": 1730, "requires": ["corvettes", "ships_of_line_4", "carronades", "large_shipyards"]},
                {"id": "ships_of_line_5", "name": "Линейные корабли V", "year": 1745, "requires": ["frigates_2", "naval_artillery_3", "fleet_artillery"]},
                {"id": "copper_plating", "name": "Медная обшивка днища", "year": 1765, "requires": ["ships_of_line_5", "quality_steel", "industrial_chemistry_2"]},
                {"id": "fast_frigates", "name": "Быстроходные фрегаты", "year": 1780, "requires": ["copper_plating", "improved_rate_of_fire", "aggressive_tactics"]},
                {"id": "ships_of_line_6", "name": "Линейные корабли VI", "year": 1795, "requires": ["fast_frigates", "naval_artillery_4", "force_concentration", "iron_rolling"]},
                {"id": "experimental_steamships", "name": "Экспериментальные паровые суда", "year": 1810, "requires": ["ships_of_line_6", "industrial_steam_power", "steam_cranes"]},
                {"id": "paddle_steamers", "name": "Паровые колесные суда", "year": 1820, "requires": ["experimental_steamships", "steam_tactics", "hot_blast"]},
                {"id": "steam_frigates_1", "name": "Паровые фрегаты I", "year": 1835, "requires": ["paddle_steamers", "efficient_steam_engines", "modern_shipyards", "explosive_bombs"]},
                {"id": "screw_ships", "name": "Винтовые корабли", "year": 1845, "requires": ["steam_frigates_1", "precision_tools", "screw_maneuverability", "quality_rolling"]},
                {"id": "steam_ships_of_line", "name": "Паровые линкоры", "year": 1855, "requires": ["screw_ships", "turret_guns_1", "steel_docks", "bessemer_process"]},
                {"id": "ironclads_1", "name": "Броненосцы I", "year": 1860, "requires": ["steam_ships_of_line", "armor_plating", "ironclad_doctrine", "mechanized_loading"]},
                {"id": "turret_ironclads", "name": "Башенные броненосцы", "year": 1870, "requires": ["ironclads_1", "turret_guns_2", "ocean_fleet", "mass_steel_production"]},
                {"id": "ironclads_2", "name": "Броненосцы II", "year": 1875, "requires": ["turret_ironclads", "armor_piercing_shells", "compound_armor", "open_hearth_process"]},
                {"id": "cruisers_1", "name": "Крейсеры I", "year": 1880, "requires": ["ironclads_2", "quick_firing_naval_guns", "triple_expansion_engines", "electric_cranes"]},
                {"id": "modern_battleships", "name": "Современные броненосцы", "year": 1885, "requires": ["cruisers_1", "heavy_naval_artillery", "harvey_armor", "sea_power_theory"]},
                {"id": "cruisers_2", "name": "Крейсеры II", "year": 1890, "requires": ["modern_battleships", "improved_torpedoes", "command_of_sea", "high_quality_steel"]},
                {"id": "pre_dreadnoughts", "name": "Эскадренные броненосцы", "year": 1895, "requires": ["cruisers_2", "krupp_armor", "modern_fire_control", "wireless_telegraph"]},
                {"id": "dreadnoughts", "name": "Дредноуты", "year": 1900, "requires": ["pre_dreadnoughts", "modern_naval_artillery", "steam_turbine_propulsion", "sea_dominance", "industrial_metallurgy"]},
            ]
        },
        {
            "id": "naval_weapons",
            ...
            "technologies": [
                ...
                {"id": "culverins", "name": "Кулеврины", "year": 1520, "requires": ["naval_bombards", "bronze_cannons", "blast_furnaces_1"]},
                {"id": "improved_naval_guns", "name": "Улучшенные морские пушки", "year": 1535, "requires": ["broadside_guns", "culverins", "cast_iron"]},
                {"id": "gun_ports", "name": "Пушечные порты", "year": 1550, "requires": ["improved_naval_guns", "improved_hull_construction"]},
                {"id": "multi_tier_armament", "name": "Многоярусное вооружение", "year": 1570, "requires": ["gun_ports", "wrought_iron", "labor_specialization"]},
                {"id": "heavy_naval_guns", "name": "Тяжелые морские пушки", "year": 1585, "requires": ["multi_tier_armament", "cast_iron_casting", "quality_iron"]},
                {"id": "caliber_standardization_navy", "name": "Стандартизация калибров", "year": 1600, "requires": ["heavy_naval_guns", "gun_standardization", "production_organization"]},
                {"id": "improved_carriages_navy", "name": "Улучшенные лафеты", "year": 1615, "requires": ["caliber_standardization_navy", "quality_craftsmanship"]},
                {"id": "anti_ship_shot", "name": "Противокорабельные ядра", "year": 1630, "requires": ["improved_carriages_navy", "foundry_production"]},
                {"id": "incendiary_shot", "name": "Зажигательные снаряды", "year": 1645, "requires": ["anti_ship_shot", "gunpowder_production", "saltpeter"]},
                {"id": "boarding_grapeshot", "name": "Картечь для абордажа", "year": 1660, "requires": ["incendiary_shot", "canister_shot"]},
                {"id": "long_range_guns", "name": "Дальнобойные пушки", "year": 1675, "requires": ["boarding_grapeshot", "coking_coal", "improved_fuses"]},
                {"id": "naval_artillery_1", "name": "Корабельная артиллерия I", "year": 1690, "requires": ["long_range_guns", "coke_blast_furnaces", "line_breaking"]},
                {"id": "explosive_shells_navy", "name": "Разрывные снаряды", "year": 1705, "requires": ["naval_artillery_1", "explosive_shells", "industrial_chemistry_1"]},
                {"id": "naval_artillery_2", "name": "Корабельная артиллерия II", "year": 1720, "requires": ["explosive_shells_navy", "rolling_mills_1", "artillery_school"]},
                {"id": "carronades", "name": "Карронады", "year": 1735, "requires": ["naval_artillery_2", "puddling", "concentrated_fire"]},
                {"id": "naval_artillery_3", "name": "Корабельная артиллерия III", "year": 1750, "requires": ["carronades", "quality_steel", "steel_barrels"]},
                {"id": "long_guns", "name": "Длинные пушки", "year": 1765, "requires": ["naval_artillery_3", "improved_range", "convoy_system"]},
                {"id": "improved_rate_of_fire", "name": "Улучшенная скорострельность", "year": 1780, "requires": ["long_guns", "iron_rolling", "standard_parts"]},
                {"id": "naval_artillery_4", "name": "Корабельная артиллерия IV", "year": 1795, "requires": ["improved_rate_of_fire", "cast_steel", "tactical_flexibility"]},
                {"id": "naval_rockets", "name": "Ракетное оружие для флота", "year": 1810, "requires": ["naval_artillery_4", "rockets", "chemical_industry"]},
                {"id": "rifled_naval_guns_1", "name": "Нарезные морские орудия I", "year": 1820, "requires": ["naval_rockets", "rifled_artillery_1", "crucible_steel"]},
                {"id": "explosive_bombs", "name": "Разрывные бомбы", "year": 1835, "requires": ["rifled_naval_guns_1", "solvay_process", "shrapnel"]},
                {"id": "breech_loading_naval_guns", "name": "Казнозарядные морские пушки", "year": 1845, "requires": ["explosive_bombs", "breech_loading_artillery", "quality_rolling"]},
                {"id": "turret_guns_1", "name": "Башенные орудия I", "year": 1855, "requires": ["breech_loading_naval_guns", "bessemer_process", "precision_tools"]},
                {"id": "armor_piercing_shells", "name": "Бронебойные снаряды", "year": 1865, "requires": ["turret_guns_1", "mass_steel_production", "high_explosive_shells"]},
                {"id": "turret_guns_2", "name": "Башенные орудия II", "year": 1870, "requires": ["armor_piercing_shells", "open_hearth_process", "hydraulic_recoil"]},
                {"id": "torpedoes", "name": "Торпеды", "year": 1875, "requires": ["turret_guns_2", "dynamite", "alloy_steel", "ocean_currents"]},
                {"id": "quick_firing_naval_guns", "name": "Скорострельные морские пушки", "year": 1880, "requires": ["torpedoes", "quick_firing_artillery", "smokeless_powder_artillery"]},
                {"id": "heavy_naval_artillery", "name": "Тяжелая корабельная артиллерия", "year": 1885, "requires": ["quick_firing_naval_guns", "high_quality_steel", "heavy_artillery"]},
                {"id": "improved_torpedoes", "name": "Улучшенные торпеды", "year": 1890, "requires": ["heavy_naval_artillery", "gyroscope", "electric_generators"]},
                {"id": "modern_naval_artillery", "name": "Современная морская артиллерия", "year": 1895, "requires": ["improved_torpedoes", "modern_fire_control", "electrometallurgy"]},
            ]
        },
        {
            "id": "navigation",
            ...
            "technologies": [
                ...
                {"id": "navigation_tables", "name": "Навигационные таблицы", "year": 1540, "requires": ["astrolabe", "sea_charts_1", "acids"]},
                {"id": "improved_sails", "name": "Улучшенные паруса", "year": 1555, "requires": ["navigation_tables", "early_manufactories"]},
                {"id": "sea_charts_2", "name": "Морские карты II", "year": 1575, "requires": ["improved_sails", "experimental_chemistry"]},
                {"id": "star_navigation", "name": "Навигация по звездам", "year": 1595, "requires": ["sea_charts_2", "glass_production"]},
                {"id": "log_speed", "name": "Лаг (измеритель скорости)", "year": 1615, "requires": ["star_navigation", "manufactory_production"]},
                {"id": "quadrant", "name": "Квадрант", "year": 1625, "requires": ["log_speed", "charcoal"]},
                {"id": "improved_compass", "name": "Улучшенные компасы", "year": 1640, "requires": ["quadrant", "foundry_production", "quality_iron"]},
                {"id": "sextant", "name": "Секстант", "year": 1655, "requires": ["improved_compass", "glass_production", "basic_chemistry"]},
                {"id": "naval_astronomy", "name": "Морская астрономия", "year": 1670, "requires": ["sextant", "hydrochloric_acid"]},
                {"id": "barometer", "name": "Барометр", "year": 1685, "requires": ["naval_astronomy", "sulfuric_acid", "vacuum_pumps"]},
                {"id": "depth_sounder", "name": "Глубиномер", "year": 1700, "requires": ["barometer", "industrial_chemistry_1"]},
                {"id": "chronometers_1", "name": "Морские хронометры I", "year": 1715, "requires": ["depth_sounder", "rolling_mills_1", "machine_production"]},
                {"id": "longitude_finding", "name": "Точное определение долготы", "year": 1730, "requires": ["chronometers_1", "industrial_chemistry_2"]},
                {"id": "scientific_cartography", "name": "Научная картография", "year": 1745, "requires": ["longitude_finding", "ammonia", "factory_system"]},
                {"id": "chronometers_2", "name": "Морские хронометры II", "year": 1760, "requires": ["scientific_cartography", "quality_steel"]},
                {"id": "sea_signals", "name": "Морские сигналы", "year": 1775, "requires": ["chronometers_2", "chemical_industry", "optical_telegraph"]},
                {"id": "semaphore_navy", "name": "Семафорная связь на флоте", "year": 1790, "requires": ["sea_signals", "iron_rolling", "semaphore_communication"]},
                {"id": "lighthouses_navy", "name": "Морские маяки", "year": 1805, "requires": ["semaphore_navy", "industrial_steam_power", "lighthouses"]},
                {"id": "precise_sea_charts", "name": "Точные морские карты", "year": 1820, "requires": ["lighthouses_navy", "standardization"]},
                {"id": "hydrography", "name": "Гидрография", "year": 1835, "requires": ["precise_sea_charts", "machine_building", "solvay_process"]},
                {"id": "steam_navigation", "name": "Паровая навигация", "year": 1850, "requires": ["hydrography", "steam_frigates_1", "compound_engines", "port_railway"]},
                {"id": "oceanography", "name": "Океанография", "year": 1860, "requires": ["steam_navigation", "organic_chemistry", "international_telegraph"]},
                {"id": "ocean_currents", "name": "Морские течения", "year": 1870, "requires": ["oceanography", "undersea_cables", "industrial_turbines"]},
                {"id": "radio_communication_navy", "name": "Радиосвязь на море", "year": 1880, "requires": ["ocean_currents", "telephone", "electric_generators"]},
                {"id": "modern_cartography", "name": "Современная картография", "year": 1890, "requires": ["radio_communication_navy", "long_distance_communication", "high_quality_steel"]},
                {"id": "electric_lighthouses", "name": "Электрическое освещение маяков", "year": 1895, "requires": ["modern_cartography", "electric_lighting", "power_stations"]},
                {"id": "modern_navigation_systems", "name": "Современные навигационные системы", "year": 1900, "requires": ["electric_lighthouses", "wireless_telegraph", "industrial_electrification"]},
            ]
        },
        {
            "id": "naval_doctrine",
            ...
            "technologies": [
                ...
                {"id": "fleet_organization", "name": "Флотская организация", "year": 1545, "requires": ["broadside_doctrine", "marines_1", "gun_ports"]},
                {"id": "squadrons", "name": "Эскадры", "year": 1565, "requires": ["fleet_organization", "multi_tier_armament", "harbors"]},
                {"id": "naval_battles", "name": "Морские сражения", "year": 1585, "requires": ["squadrons", "heavy_naval_guns", "port_infrastructure"]},
                {"id": "fleet_discipline", "name": "Флотская дисциплина", "year": 1605, "requires": ["naval_battles", "caliber_standardization_navy", "production_organization"]},
                {"id": "line_formation", "name": "Построение линией", "year": 1620, "requires": ["fleet_discipline", "improved_carriages_navy"]},
                {"id": "linear_fleet_tactics_1", "name": "Линейная тактика флота I", "year": 1640, "requires": ["line_formation", "ships_of_line_1", "anti_ship_shot"]},
                {"id": "squadron_coordination", "name": "Координация эскадр", "year": 1655, "requires": ["linear_fleet_tactics_1", "incendiary_shot", "dry_docks"]},
                {"id": "fleet_signals", "name": "Флотские сигналы", "year": 1670, "requires": ["squadron_coordination", "naval_astronomy", "boarding_grapeshot"]},
                {"id": "line_breaking", "name": "Тактика прорыва линии", "year": 1685, "requires": ["fleet_signals", "naval_artillery_1", "barometer"]},
                {"id": "concentrated_fire", "name": "Сосредоточение огня", "year": 1700, "requires": ["line_breaking", "depth_sounder", "coke_blast_furnaces"]},
                {"id": "cruiser_operations", "name": "Крейсерские операции", "year": 1715, "requires": ["concentrated_fire", "frigates_1", "chronometers_1"]},
                {"id": "port_blockade", "name": "Блокада портов", "year": 1730, "requires": ["cruiser_operations", "frigates_2", "longitude_finding"]},
                {"id": "fleet_artillery", "name": "Флотская артиллерия", "year": 1745, "requires": ["port_blockade", "naval_artillery_3", "scientific_cartography"]},
                {"id": "convoy_system", "name": "Конвойная система", "year": 1760, "requires": ["fleet_artillery", "chronometers_2", "long_guns"]},
                {"id": "aggressive_tactics", "name": "Агрессивная тактика", "year": 1775, "requires": ["convoy_system", "sea_signals", "improved_rate_of_fire"]},
                {"id": "force_concentration", "name": "Сосредоточение сил", "year": 1790, "requires": ["aggressive_tactics", "semaphore_navy", "naval_artillery_4"]},
                {"id": "tactical_flexibility", "name": "Тактическая гибкость", "year": 1805, "requires": ["force_concentration", "lighthouses_navy", "naval_rockets"]},
                {"id": "steam_tactics", "name": "Паровая тактика", "year": 1820, "requires": ["tactical_flexibility", "paddle_steamers", "rifled_naval_guns_1"]},
                {"id": "screw_maneuverability", "name": "Винтовая маневренность", "year": 1835, "requires": ["steam_tactics", "screw_propeller", "explosive_bombs", "hydrography"]},
                {"id": "ironclad_doctrine", "name": "Броненосная доктрина", "year": 1850, "requires": ["screw_maneuverability", "steam_navigation", "turret_guns_1"]},
                {"id": "modern_naval_warfare", "name": "Современная морская война", "year": 1860, "requires": ["ironclad_doctrine", "ironclads_1", "armor_piercing_shells", "oceanography"]},
                {"id": "ocean_fleet", "name": "Океанский флот", "year": 1870, "requires": ["modern_naval_warfare", "turret_ironclads", "torpedoes", "ocean_currents"]},
                {"id": "modern_fleet_organization", "name": "Современная организация флота", "year": 1875, "requires": ["ocean_fleet", "ironclads_2", "radio_communication_navy"]},
                {"id": "sea_power_theory", "name": "Теория морской мощи", "year": 1880, "requires": ["modern_fleet_organization", "cruisers_1", "quick_firing_naval_guns"]},
                {"id": "command_of_sea", "name": "Командование морем", "year": 1890, "requires": ["sea_power_theory", "modern_battleships", "improved_torpedoes", "modern_cartography"]},
                {"id": "sea_dominance", "name": "Доминирование на море", "year": 1900, "requires": ["command_of_sea", "pre_dreadnoughts", "modern_naval_artillery", "modern_navigation_systems"]},
            ]
        },
        {
            "id": "shipbuilding",
            ...
            "technologies": [
                {"id": "wooden_hulls", "name": "Деревянные корпуса", "year": 1500, "requires": []},
                {"id": "traditional_shipbuilding", "name": "Традиционное кораблестроение", "year": 1500, "requires": []},
                {"id": "improved_hull_construction", "name": "Улучшенная конструкция корпуса", "year": 1520, "requires": ["wooden_hulls", "blacksmithing"]},
                {"id": "carvel_planking", "name": "Обшивка вгладь", "year": 1530, "requires": ["traditional_shipbuilding", "workshops"]},
                {"id": "reinforced_keels", "name": "Усиленные кили", "year": 1540, "requires": ["improved_hull_construction", "carvel_planking", "iron_ore"]},
                {"id": "improved_rigging", "name": "Улучшенный такелаж", "year": 1550, "requires": ["reinforced_keels", "early_manufactories"]},
                {"id": "improved_masts", "name": "Улучшенные мачты", "year": 1570, "requires": ["improved_rigging", "quality_iron"]},
                {"id": "strengthened_hulls", "name": "Усиленные корпуса", "year": 1590, "requires": ["improved_masts", "steel_production_1"]},
                {"id": "shipyard_techniques", "name": "Верфяные техники", "year": 1610, "requires": ["strengthened_hulls", "shipyards", "manufactory_production"]},
                {"id": "ship_standardization", "name": "Стандартизация кораблей", "year": 1630, "requires": ["shipyard_techniques", "large_manufactories"]},
                {"id": "improved_timber_treatment", "name": "Улучшенная обработка древесины", "year": 1650, "requires": ["ship_standardization", "saltpeter"]},
                {"id": "naval_architecture", "name": "Корабельная архитектура", "year": 1670, "requires": ["improved_timber_treatment", "production_organization", "coal_for_metallurgy"]},
                {"id": "scientific_shipbuilding", "name": "Научное кораблестроение", "year": 1690, "requires": ["naval_architecture", "machine_production", "coke_blast_furnaces"]},
                {"id": "hull_design", "name": "Проектирование корпусов", "year": 1710, "requires": ["scientific_shipbuilding", "mechanized_production"]},
                {"id": "shipbuilding_techniques", "name": "Кораблестроительные техники", "year": 1730, "requires": ["hull_design", "standard_parts", "puddling"]},
                {"id": "iron_fittings", "name": "Железная оснастка", "year": 1750, "requires": ["shipbuilding_techniques", "factory_system", "quality_steel"]},
                {"id": "composite_construction", "name": "Композитная конструкция", "year": 1770, "requires": ["iron_fittings", "industrial_production_prod", "leblanc_process"]},
                {"id": "iron_frames", "name": "Железные шпангоуты", "year": 1780, "requires": ["composite_construction", "iron_rolling"]},
                {"id": "iron_hulls", "name": "Железные корпуса", "year": 1800, "requires": ["iron_frames", "factory_production_methods", "cast_steel"]},
                {"id": "steam_propulsion_design", "name": "Проектирование паровых движителей", "year": 1815, "requires": ["iron_hulls", "interchangeable_parts", "crucible_steel"]},
                {"id": "screw_propeller", "name": "Гребной винт", "year": 1830, "requires": ["steam_propulsion_design", "machine_building", "solvay_process"]},
                {"id": "armor_plating", "name": "Бронирование", "year": 1845, "requires": ["screw_propeller", "quality_rolling", "precision_tools"]},
                {"id": "steel_hulls", "name": "Стальные корпуса", "year": 1855, "requires": ["armor_plating", "bessemer_process"]},
                {"id": "compound_armor", "name": "Композитная броня", "year": 1865, "requires": ["steel_hulls", "mass_steel_production", "assembly_line"]},
                {"id": "triple_expansion_engines", "name": "Тройного расширения машины", "year": 1870, "requires": ["compound_armor", "open_hearth_process", "mass_production"]},
                {"id": "harvey_armor", "name": "Гарвеевская броня", "year": 1880, "requires": ["triple_expansion_engines", "alloy_steel", "production_electrification"]},
                {"id": "krupp_armor", "name": "Крупповская броня", "year": 1890, "requires": ["harvey_armor", "high_quality_steel", "electrometallurgy"]},
                {"id": "modern_fire_control", "name": "Современные системы управления огнём", "year": 1893, "requires": ["krupp_armor", "telephone_exchanges"]},
                {"id": "gyroscope", "name": "Гироскоп", "year": 1895, "requires": ["modern_fire_control", "electric_grids"]},
                {"id": "steam_turbine_propulsion", "name": "Паротурбинные двигатели", "year": 1897, "requires": ["gyroscope", "modern_factories"]},
                {"id": "modern_shipbuilding", "name": "Современное кораблестроение", "year": 1900, "requires": ["steam_turbine_propulsion", "industrial_metallurgy", "industrial_organization"]},
            ]
        }
    ]
}
