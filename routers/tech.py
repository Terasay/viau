    ...
    "lines": [
        ...
        },
        {
            ...
            "technologies": [
                ...
                {"id": "scientific_laboratories_1", "name": "Научные лаборатории I", "year": 1690, "requires": ["mathematics_2"]},
                {"id": "calculus", "name": "Исчисление", "year": 1705, "requires": ["scientific_laboratories_1"]},
                {"id": "physics_1", "name": "Физика I", "year": 1720, "requires": ["calculus"]},
                {"id": "astronomy", "name": "Астрономия", "year": 1735, "requires": ["physics_1"]},
                {"id": "scientific_research_1", "name": "Научные исследования I", "year": 1750, "requires": ["astronomy"]},
    ...
    "lines": [
        {
            ...
            "technologies": [
                ...
                {"id": "merchant_banks", "name": "Торговые банки", "year": 1580, "requires": ["lending", "bills_of_exchange"]},
                {"id": "state_credit", "name": "Государственный кредит", "year": 1600, "requires": ["merchant_banks"]},
                {"id": "stock_exchanges_early", "name": "Биржи", "year": 1620, "requires": ["state_credit"]},
                ...
                {"id": "stock_trading", "name": "Биржевая торговля", "year": 1700, "requires": ["stocks_bonds"]},
                {"id": "paper_money", "name": "Бумажные деньги", "year": 1720, "requires": ["central_banks", "printing_knowledge"]},
                {"id": "insurance", "name": "Страхование", "year": 1735, "requires": ["merchant_banks", "maritime_trade"]},
                ...
                {"id": "financial_markets", "name": "Финансовые рынки", "year": 1775, "requires": ["securities", "insurance"]},
                {"id": "national_banks", "name": "Национальные банки", "year": 1790, "requires": ["central_banks", "financial_markets"]},
                {"id": "commercial_banks", "name": "Коммерческие банки", "year": 1810, "requires": ["national_banks"]},
                {"id": "savings_banks", "name": "Сберегательные банки", "year": 1825, "requires": ["commercial_banks"]},
                {"id": "mortgage_lending", "name": "Ипотечное кредитование", "year": 1840, "requires": ["savings_banks"]},
                ...
                {"id": "industrial_financing", "name": "Промышленное финансирование", "year": 1880, "requires": ["modern_banking", "mass_steel_production"]},
                {"id": "insurance_companies", "name": "Страховые компании", "year": 1885, "requires": ["insurance", "modern_banking"]},
                {"id": "international_finance", "name": "Международные финансы", "year": 1890, "requires": ["industrial_financing", "international_trade_system"]},
                {"id": "investment_banking", "name": "Инвестиционный банкинг", "year": 1895, "requires": ["international_finance", "stock_markets"]},
                {"id": "modern_financial_system", "name": "Современная финансовая система", "year": 1900, "requires": ["investment_banking", "insurance_companies"]},
            ]
        },
        {
            "id": "trade_commerce",
            ...
            "technologies": [
                ...
                {"id": "merchant_guilds", "name": "Гильдии купцов", "year": 1545, "requires": ["fairs"]},
                ...
                {"id": "warehouse_system", "name": "Складская система", "year": 1600, "requires": ["trading_companies"]},
                {"id": "trading_ports", "name": "Торговые порты", "year": 1620, "requires": ["maritime_trade", "warehouse_system"]},
                {"id": "trade_routes", "name": "Торговые маршруты", "year": 1635, "requires": ["trading_ports", "caravan_trade"]},
                {"id": "colonial_trade", "name": "Колониальная торговля", "year": 1650, "requires": ["trade_routes"]},
                {"id": "trade_monopolies", "name": "Торговые монополии", "year": 1665, "requires": ["colonial_trade"]},
                {"id": "merchant_fleet", "name": "Торговый флот", "year": 1685, "requires": ["maritime_trade", "ship_construction"]},
                ...
                {"id": "triangular_trade", "name": "Треугольная торговля", "year": 1730, "requires": ["international_markets"]},
                {"id": "free_trade_movement", "name": "Движение свободной торговли", "year": 1750, "requires": ["triangular_trade"]},
                {"id": "trade_treaties", "name": "Торговые договоры", "year": 1760, "requires": ["free_trade_movement"]},
                ...
                {"id": "trade_infrastructure", "name": "Торговая инфраструктура", "year": 1790, "requires": ["international_commerce", "improved_roads"]},
                {"id": "trade_liberalization", "name": "Либерализация торговли", "year": 1800, "requires": ["trade_infrastructure", "steam_power"]},
                {"id": "steamship_trade", "name": "Пароходная торговля", "year": 1820, "requires": ["trade_liberalization", "steam_engine_ships"]},
                {"id": "customs_unions", "name": "Таможенные союзы", "year": 1830, "requires": ["trade_liberalization"]},
                {"id": "international_exhibitions", "name": "Международные выставки", "year": 1850, "requires": ["customs_unions", "mass_production"]},
                {"id": "telegraph_trade", "name": "Телеграфная торговля", "year": 1860, "requires": ["steamship_trade", "telegraph"]},
                {"id": "commodity_exchanges", "name": "Товарные биржи", "year": 1870, "requires": ["telegraph_trade"]},
                {"id": "railway_trade", "name": "Железнодорожная торговля", "year": 1875, "requires": ["steamship_trade", "railways"]},
                {"id": "global_trade", "name": "Глобальная торговля", "year": 1880, "requires": ["railway_trade", "commodity_exchanges"]},
                {"id": "modern_commerce", "name": "Современная коммерция", "year": 1890, "requires": ["global_trade", "international_exhibitions"]},
        ...
        },
        {
            ...
            "technologies": [
                ...
                {"id": "improved_plough", "name": "Улучшенный плуг", "year": 1520, "requires": ["three_field_system"]},
                {"id": "agricultural_tools", "name": "Сельскохозяйственные орудия", "year": 1530, "requires": ["three_field_system"]},
                {"id": "crop_rotation", "name": "Севооборот", "year": 1545, "requires": ["improved_plough", "agricultural_tools"]},
                ...
                {"id": "new_crops", "name": "Новые культуры", "year": 1620, "requires": ["selection", "colonial_trade"]},
                {"id": "improved_farming", "name": "Улучшенное земледелие", "year": 1640, "requires": ["land_drainage", "new_crops"]},
                {"id": "four_field_system", "name": "Четырехполье", "year": 1660, "requires": ["improved_farming"]},
                {"id": "root_crops", "name": "Корнеплоды", "year": 1680, "requires": ["four_field_system"]},
                {"id": "animal_selection", "name": "Селекция животных", "year": 1700, "requires": ["selection"]},
                {"id": "multi_field_rotation", "name": "Многопольный севооборот", "year": 1715, "requires": ["root_crops", "animal_selection"]},
                {"id": "grass_farming", "name": "Травосеяние", "year": 1730, "requires": ["animal_selection"]},
                {"id": "drainage_systems", "name": "Дренажные системы", "year": 1740, "requires": ["grass_farming", "hydraulic_systems"]},
                {"id": "intensive_farming", "name": "Интенсивное земледелие", "year": 1760, "requires": ["multi_field_rotation", "drainage_systems"]},
                ...
                {"id": "mechanical_seeders", "name": "Механические сеялки", "year": 1810, "requires": ["agricultural_science"]},
                {"id": "threshers", "name": "Молотилки", "year": 1820, "requires": ["agricultural_science"]},
                {"id": "mechanical_reapers", "name": "Механические жатки", "year": 1840, "requires": ["mechanical_seeders", "threshers"]},
                {"id": "chemical_fertilizers", "name": "Химические удобрения", "year": 1850, "requires": ["modern_chemical_industry", "agricultural_science"]},
                {"id": "agricultural_machines", "name": "Сельскохозяйственные машины", "year": 1860, "requires": ["mechanical_reapers", "machine_tools"]},
                {"id": "steam_ploughs", "name": "Паровые плуги", "year": 1870, "requires": ["agricultural_machines", "steam_power"]},
        ...
        },
        {
            ...
            "technologies": [
                ...
                {"id": "ore_mines", "name": "Рудники", "year": 1540, "requires": ["shaft_mining"]},
                ...
                {"id": "ore_extraction", "name": "Добыча руды", "year": 1590, "requires": ["ore_mines", "mine_drainage"]},
                {"id": "deep_mines", "name": "Глубокие шахты", "year": 1610, "requires": ["mine_drainage"]},
                {"id": "coal_mining", "name": "Добыча угля", "year": 1630, "requires": ["deep_mines"]},
                {"id": "improved_extraction", "name": "Улучшенная добыча", "year": 1650, "requires": ["ore_extraction", "coal_mining"]},
                {"id": "steam_pumps_mines", "name": "Паровые насосы для шахт", "year": 1670, "requires": ["improved_extraction", "savery_pump"]},
                {"id": "mine_safety", "name": "Шахтная безопасность", "year": 1690, "requires": ["steam_pumps_mines"]},
                ...
                {"id": "improved_ventilation", "name": "Улучшенная вентиляция", "year": 1770, "requires": ["vertical_shafts"]},
                {"id": "industrial_extraction", "name": "Промышленная добыча", "year": 1790, "requires": ["improved_ventilation"]},
                {"id": "steam_cutting_machines", "name": "Паровые врубовые машины", "year": 1810, "requires": ["industrial_extraction", "high_pressure_steam"]},
                {"id": "mine_railways", "name": "Железные рельсы в шахтах", "year": 1830, "requires": ["steam_cutting_machines", "rolling_mills"]},
                {"id": "dynamite_mining", "name": "Динамит для горных работ", "year": 1850, "requires": ["mine_railways", "dynamite"]},
                {"id": "deep_coal_mining", "name": "Глубокая добыча угля", "year": 1860, "requires": ["dynamite_mining"]},
                {"id": "mechanized_extraction", "name": "Механизированная добыча", "year": 1875, "requires": ["deep_coal_mining", "compound_engines"]},
        ...
        },
        {
            ...
            "technologies": [
                ...
                {"id": "tax_system_basic", "name": "Налоговая система", "year": 1530, "requires": ["city_taxes"]},
                ...
                {"id": "unified_tax_system", "name": "Единая налоговая система", "year": 1660, "requires": ["poll_tax", "land_tax", "trade_duties"]},
                {"id": "income_tax", "name": "Подоходный налог", "year": 1680, "requires": ["unified_tax_system"]},
                {"id": "tax_administration", "name": "Налоговая администрация", "year": 1700, "requires": ["income_tax"]},
                ...
                {"id": "tax_reforms", "name": "Налоговые реформы", "year": 1770, "requires": ["financial_control"]},
                {"id": "efficient_tax_collection", "name": "Эффективный налоговый сбор", "year": 1785, "requires": ["tax_reforms"]},
                {"id": "progressive_taxation", "name": "Прогрессивное налогообложение", "year": 1810, "requires": ["efficient_tax_collection"]},
                {"id": "profit_tax", "name": "Налог на прибыль", "year": 1830, "requires": ["progressive_taxation"]},
                {"id": "tax_inspection", "name": "Налоговая инспекция", "year": 1850, "requires": ["profit_tax"]},
                {"id": "corporate_taxes", "name": "Корпоративные налоги", "year": 1865, "requires": ["tax_inspection", "modern_banking"]},
                {"id": "financial_reporting", "name": "Финансовая отчетность", "year": 1880, "requires": ["corporate_taxes"]},
                {"id": "budget_planning", "name": "Бюджетное планирование", "year": 1890, "requires": ["financial_reporting"]},
    ...
    "lines": [
        {
            ...
            "technologies": [
                ...
                {"id": "road_network", "name": "Дорожная сеть", "year": 1590, "requires": ["post_stations_roads", "stone_bridges"]},
                ...
                {"id": "improved_bridges", "name": "Улучшенные мосты", "year": 1670, "requires": ["main_roads"]},
                {"id": "canals", "name": "Каналы", "year": 1680, "requires": ["main_roads"]},
                {"id": "locks", "name": "Шлюзы", "year": 1690, "requires": ["canals"]},
                {"id": "macadam_roads", "name": "Макадамовское покрытие", "year": 1720, "requires": ["improved_bridges"]},
                {"id": "river_navigation", "name": "Речное судоходство", "year": 1740, "requires": ["locks"]},
                {"id": "modern_bridges", "name": "Современные мосты", "year": 1760, "requires": ["macadam_roads"]},
                {"id": "navigable_canals", "name": "Судоходные каналы", "year": 1780, "requires": ["river_navigation", "modern_bridges"]},
                ...
                {"id": "railway_bridges", "name": "Железнодорожные мосты", "year": 1855, "requires": ["railway_network", "cast_iron"]},
                {"id": "national_railway_network", "name": "Национальная железнодорожная сеть", "year": 1870, "requires": ["railway_bridges"]},
        ...
        },
        {
            ...
            "technologies": [
                ...
                {"id": "urban_planning", "name": "Городское планирование", "year": 1570, "requires": ["multi_story_buildings", "city_fortifications"]},
                ...
                {"id": "wide_streets", "name": "Широкие улицы", "year": 1730, "requires": ["public_parks", "street_lighting"]},
        ...
        },
        {
            ...
            "technologies": [
                ...
                {"id": "port_warehouses", "name": "Портовые склады", "year": 1550, "requires": ["improved_piers", "stone_moles"]},
                ...
                {"id": "dry_docks", "name": "Сухие доки", "year": 1670, "requires": ["stone_docks"]},
                {"id": "port_cranes", "name": "Портовые краны", "year": 1680, "requires": ["dry_docks"]},
                {"id": "deep_water_ports", "name": "Глубоководные порты", "year": 1720, "requires": ["port_cranes"]},
                {"id": "lighthouses", "name": "Маяки", "year": 1730, "requires": ["deep_water_ports"]},
                ...
                {"id": "large_shipyards", "name": "Крупные верфи", "year": 1770, "requires": ["shipyards", "foundry_production"]},
                {"id": "stone_breakwaters", "name": "Каменные волноломы", "year": 1790, "requires": ["large_shipyards"]},
        ...
        },
        {
            ...
            "technologies": [
                ...
                {"id": "postal_service", "name": "Почтовая служба", "year": 1520, "requires": ["courier_service"]},
                ...
                {"id": "postal_routes", "name": "Почтовые маршруты", "year": 1570, "requires": ["regular_mail", "state_post"]},
                {"id": "post_offices", "name": "Почтовые конторы", "year": 1590, "requires": ["postal_routes"]},
                {"id": "postal_network", "name": "Почтовая сеть", "year": 1610, "requires": ["post_offices"]},
                {"id": "mail_coaches", "name": "Почтовые кареты", "year": 1620, "requires": ["postal_network"]},
                {"id": "postal_system", "name": "Почтовая система", "year": 1650, "requires": ["mail_coaches"]},
                ...
                {"id": "signal_towers", "name": "Сигнальные башни", "year": 1740, "requires": ["semaphore_communication"]},
                {"id": "telegraph_network", "name": "Телеграфная сеть", "year": 1750, "requires": ["signal_towers"]},
                {"id": "railway_mail", "name": "Железнодорожная почта", "year": 1780, "requires": ["telegraph_network", "railways"]},
                {"id": "modern_postal_system", "name": "Современная почтовая система", "year": 1800, "requires": ["railway_mail"]},      
                ...
                {"id": "morse_code", "name": "Азбука Морзе", "year": 1840, "requires": ["telegraph_lines"]},
                {"id": "international_telegraph", "name": "Международный телеграф", "year": 1860, "requires": ["morse_code"]},               
