    ...
    "lines": [
        {
            ...
            "technologies": [
                ...
                {"id": "galleons_2", "name": "Галеоны II", "year": 1565, "requires": ["galleons_1"]},
                ...
                {"id": "frigates_1", "name": "Фрегаты I", "year": 1665, "requires": ["galleons_2"]},
                ...
                {"id": "frigates_2", "name": "Фрегаты II", "year": 1730, "requires": ["corvettes"]},
                {"id": "ships_of_line_5", "name": "Линейные корабли V", "year": 1745, "requires": ["ships_of_line_4"]},
                ...
                {"id": "ships_of_line_6", "name": "Линейные корабли VI", "year": 1795, "requires": ["ships_of_line_5", "carronades"]},
                ...
                {"id": "steam_frigates_1", "name": "Паровые фрегаты I", "year": 1835, "requires": ["paddle_steamers", "fast_frigates", "improved_steam_engines"]},
                ...
                {"id": "cruisers_1", "name": "Крейсеры I", "year": 1880, "requires": ["steam_frigates_1", "ironclads_1"]},
                {"id": "modern_battleships", "name": "Современные броненосцы", "year": 1885, "requires": ["ironclads_2", "heavy_naval_artillery"]},
                {"id": "cruisers_2", "name": "Крейсеры II", "year": 1890, "requires": ["cruisers_1"]},
                {"id": "pre_dreadnoughts", "name": "Эскадренные броненосцы", "year": 1895, "requires": ["modern_battleships"]},
        ...
        },
        {
            ...
            "technologies": [
                ...
                {"id": "improved_naval_guns", "name": "Улучшенные морские пушки", "year": 1535, "requires": ["broadside_guns"]},
                ...
                {"id": "heavy_naval_guns", "name": "Тяжелые морские пушки", "year": 1585, "requires": ["culverins", "iron_casting"]},
                ...
                {"id": "boarding_grapeshot", "name": "Картечь для абордажа", "year": 1660, "requires": ["broadside_guns"]},
                {"id": "long_range_guns", "name": "Дальнобойные пушки", "year": 1675, "requires": ["heavy_naval_guns"]},
                ...
                {"id": "carronades", "name": "Карронады", "year": 1735, "requires": ["naval_artillery_1"]},
                {"id": "naval_artillery_3", "name": "Корабельная артиллерия III", "year": 1750, "requires": ["naval_artillery_2"]},
                {"id": "long_guns", "name": "Длинные пушки", "year": 1765, "requires": ["naval_artillery_3"]},
                {"id": "improved_rate_of_fire", "name": "Улучшенная скорострельность", "year": 1780, "requires": ["carronades", "precision_machining"]},
                {"id": "naval_artillery_4", "name": "Корабельная артиллерия IV", "year": 1795, "requires": ["long_guns", "improved_rate_of_fire"]},
                {"id": "naval_rockets", "name": "Ракетное оружие для флота", "year": 1810, "requires": ["naval_artillery_4", "rockets"]},
                {"id": "rifled_naval_guns_1", "name": "Нарезные морские орудия I", "year": 1820, "requires": ["naval_artillery_4", "rifled_artillery"]},
                ...
                {"id": "torpedoes", "name": "Торпеды", "year": 1875, "requires": ["explosive_bombs", "dynamite"]},
                {"id": "quick_firing_naval_guns", "name": "Скорострельные морские пушки", "year": 1880, "requires": ["turret_guns_2", "improved_rate_of_fire"]},
                {"id": "heavy_naval_artillery", "name": "Тяжелая корабельная артиллерия", "year": 1885, "requires": ["quick_firing_naval_guns"]},
                {"id": "improved_torpedoes", "name": "Улучшенные торпеды", "year": 1890, "requires": ["torpedoes"]},
        ...
        },
        {
            ...
            "technologies": [
                ...
                {"id": "navigation_tables", "name": "Навигационные таблицы", "year": 1540, "requires": ["astrolabe"]},
                {"id": "improved_sails", "name": "Улучшенные паруса", "year": 1555, "requires": ["navigation_tables"]},
                {"id": "sea_charts_2", "name": "Морские карты II", "year": 1575, "requires": ["sea_charts_1"]},
                ...
                {"id": "quadrant", "name": "Квадрант", "year": 1625, "requires": ["astrolabe"]},
                {"id": "improved_compass", "name": "Улучшенные компасы", "year": 1640, "requires": ["quadrant", "precision_metalworking"]},
                {"id": "sextant", "name": "Секстант", "year": 1655, "requires": ["quadrant", "optics"]},
                ...
                {"id": "chronometers_1", "name": "Морские хронометры I", "year": 1715, "requires": ["sextant", "precision_clockmaking"]},
                {"id": "longitude_finding", "name": "Точное определение долготы", "year": 1730, "requires": ["chronometers_1"]},
                {"id": "scientific_cartography", "name": "Научная картография", "year": 1745, "requires": ["longitude_finding", "sea_charts_2"]},
                {"id": "chronometers_2", "name": "Морские хронометры II", "year": 1760, "requires": ["scientific_cartography"]},
                {"id": "sea_signals", "name": "Морские сигналы", "year": 1775, "requires": ["chronometers_1"]},
                {"id": "semaphore", "name": "Семафорная связь", "year": 1790, "requires": ["sea_signals"]},
                {"id": "lighthouses", "name": "Морские маяки", "year": 1805, "requires": ["sea_charts_2"]},
                {"id": "precise_sea_charts", "name": "Точные морские карты", "year": 1820, "requires": ["scientific_cartography"]},
                {"id": "hydrography", "name": "Гидрография", "year": 1835, "requires": ["precise_sea_charts"]},
                {"id": "steam_navigation", "name": "Паровая навигация", "year": 1850, "requires": ["chronometers_2", "steam_frigates_1"]},
                {"id": "oceanography", "name": "Океанография", "year": 1860, "requires": ["hydrography", "scientific_research_3"]},
                {"id": "ocean_currents", "name": "Морские течения", "year": 1870, "requires": ["oceanography"]},
                {"id": "radio_communication_navy", "name": "Радиосвязь на море", "year": 1880, "requires": ["semaphore", "telegraph"]},
                {"id": "modern_cartography", "name": "Современная картография", "year": 1890, "requires": ["radio_communication_navy", "ocean_currents"]},
                {"id": "electric_lighthouses", "name": "Электрическое освещение маяков", "year": 1895, "requires": ["lighthouses", "electric_lighting"]},
                {"id": "modern_navigation_systems", "name": "Современные навигационные системы", "year": 1900, "requires": ["modern_cartography", "radio_communication_navy"]}
            ]
        },
        {
            "id": "naval_doctrine",
            ...
            "technologies": [
                ...
                { "id": "marines_1", "name": "Морская пехота I", "year": 1540, "requires": ["boarding_tactics", "ship_discipline"] },
                ...
                { "id": "naval_battles", "name": "Морские сражения", "year": 1585, "requires": ["squadrons", "marines_1"] },
                { "id": "fleet_discipline", "name": "Флотская дисциплина", "year": 1605, "requires": ["naval_battles"] },
                { "id": "line_formation", "name": "Построение линией", "year": 1620, "requires": ["fleet_discipline", "broadside_doctrine"] },
                { "id": "linear_fleet_tactics_1", "name": "Линейная тактика флота I", "year": 1640, "requires": ["line_formation", "ships_of_line_1"] },
                { "id": "squadron_coordination", "name": "Координация эскадр", "year": 1655, "requires": ["squadrons", "linear_fleet_tactics_1"] },
                { "id": "fleet_signals", "name": "Флотские сигналы", "year": 1670, "requires": ["squadron_coordination", "sea_signals"] },
                { "id": "line_breaking", "name": "Тактика прорыва линии", "year": 1685, "requires": ["linear_fleet_tactics_1", "fleet_signals"] },
                { "id": "concentrated_fire", "name": "Сосредоточение огня", "year": 1700, "requires": ["broadside_doctrine", "line_breaking"] },
                { "id": "cruiser_operations", "name": "Крейсерские операции", "year": 1715, "requires": ["fleet_signals", "frigates_2"] },
                { "id": "port_blockade", "name": "Блокада портов", "year": 1730, "requires": ["cruiser_operations", "naval_battles"] },
                { "id": "fleet_artillery", "name": "Флотская артиллерия", "year": 1745, "requires": ["concentrated_fire", "naval_artillery_3"] },
                { "id": "convoy_system", "name": "Конвойная система", "year": 1760, "requires": ["cruiser_operations", "fleet_signals"] },
                { "id": "aggressive_tactics", "name": "Агрессивная тактика", "year": 1775, "requires": ["concentrated_fire", "port_blockade"] },
                { "id": "force_concentration", "name": "Сосредоточение сил", "year": 1790, "requires": ["aggressive_tactics", "fleet_discipline"] },
                { "id": "tactical_flexibility", "name": "Тактическая гибкость", "year": 1805, "requires": ["force_concentration", "semaphore"] },
                { "id": "steam_tactics", "name": "Паровая тактика", "year": 1820, "requires": ["tactical_flexibility", "cruiser_operations", "paddle_steamers"] },
                { "id": "screw_maneuverability", "name": "Винтовая маневренность", "year": 1835, "requires": ["steam_tactics", "screw_ships"] },
                { "id": "ironclad_doctrine", "name": "Броненосная доктрина", "year": 1850, "requires": ["screw_maneuverability", "fleet_artillery", "ironclads_1"] },
                { "id": "modern_naval_warfare", "name": "Современная морская война", "year": 1860, "requires": ["ironclad_doctrine", "tactical_flexibility"] },
                { "id": "ocean_fleet", "name": "Океанский флот", "year": 1870, "requires": ["modern_naval_warfare", "convoy_system"] },
                ...
                { "id": "sea_dominance", "name": "Доминирование на море", "year": 1900, "requires": ["command_of_sea", "force_concentration"] }
            ]
        }
    ]
}
