...
async def get_available_military_equipment():
    ...
    equipment_types = {
        ...
        # Артиллерия (на 25 ед.)
        'field_artillery': {'name': 'Полевая артиллерия', 'icon': 'fa-bomb', 'price': 200, 'batch_size': 25, 'resources': {'wood': 5, 'iron': 20, 'bronze': 5}, 'required_tech': 'field_artillery_1', 'required_tech_name': get_tech_name('field_artillery_1')},
        'siege_artillery': {'name': 'Осадная артиллерия', 'icon': 'fa-bomb', 'price': 350, 'batch_size': 25, 'resources': {'wood': 8, 'iron': 35, 'bronze': 7}, 'required_tech': 'siege_artillery', 'required_tech_name': get_tech_name('siege_artillery')},
        'heavy_artillery': {'name': 'Тяжёлая артиллерия', 'icon': 'fa-bomb', 'price': 500, 'batch_size': 25, 'resources': {'wood': 10, 'iron': 50, 'bronze': 10}, 'required_tech': 'heavy_artillery', 'required_tech_name': get_tech_name('heavy_artillery')},
        
        # Техника (на 15 ед.)
        'transport_vehicles': {'name': 'Грузовики', 'icon': 'fa-truck', 'price': 150, 'batch_size': 15, 'resources': {'wood': 3, 'iron': 12}, 'required_tech': 'internal_combustion', 'required_tech_name': get_tech_name('internal_combustion')},
        'armored_vehicles': {'name': 'Бронетранспортёры', 'icon': 'fa-truck-monster', 'price': 400, 'batch_size': 15, 'resources': {'wood': 2, 'iron': 18, 'bronze': 3}, 'required_tech': 'armored_cars', 'required_tech_name': get_tech_name('armored_cars')},
        'light_tanks': {'name': 'Лёгкие танки', 'icon': 'fa-shield-alt', 'price': 1000, 'batch_size': 15, 'resources': {'wood': 1, 'iron': 30, 'bronze': 5}, 'required_tech': 'light_tanks', 'required_tech_name': get_tech_name('light_tanks')},
        'medium_tanks': {'name': 'Средние танки', 'icon': 'fa-shield-alt', 'price': 1800, 'batch_size': 15, 'resources': {'wood': 1, 'iron': 45, 'bronze': 8}, 'required_tech': 'medium_tanks', 'required_tech_name': get_tech_name('medium_tanks')},
        'heavy_tanks': {'name': 'Тяжёлые танки', 'icon': 'fa-shield-alt', 'price': 3000, 'batch_size': 15, 'resources': {'wood': 1, 'iron': 70, 'bronze': 12}, 'required_tech': 'heavy_tanks', 'required_tech_name': get_tech_name('heavy_tanks')},
        'fighters': {'name': 'Истребители', 'icon': 'fa-plane', 'price': 2000, 'batch_size': 15, 'resources': {'wood': 3, 'iron': 20, 'cuprum': 5}, 'required_tech': 'fighters', 'required_tech_name': get_tech_name('fighters')},
        ...
        'galleons': {'name': 'Галеоны', 'icon': 'fa-ship', 'price': 500, 'batch_size': 1, 'resources': {'wood': 120, 'iron': 10, 'bronze': 3}, 'required_tech': 'galleons_1', 'required_tech_name': get_tech_name('galleons_1')},
        ...
        'pre_dreadnoughts': {'name': 'Эскадренные броненосцы', 'icon': 'fa-ship', 'price': 5000, 'batch_size': 1, 'resources': {'wood': 15, 'iron': 170, 'bronze': 20}, 'required_tech': 'pre_dreadnought', 'required_tech_name': get_tech_name('pre_dreadnought')},
        'dreadnoughts': {'name': 'Дредноуты', 'icon': 'fa-ship', 'price': 8000, 'batch_size': 1, 'resources': {'wood': 10, 'iron': 260, 'bronze': 30}, 'required_tech': 'dreadnought', 'required_tech_name': get_tech_name('dreadnought')},
        'destroyers': {'name': 'Эсминцы', 'icon': 'fa-ship', 'price': 1500, 'batch_size': 1, 'resources': {'wood': 5, 'iron': 60, 'bronze': 6}, 'required_tech': 'destroyers', 'required_tech_name': get_tech_name('destroyers')},
        'cruisers': {'name': 'Крейсера', 'icon': 'fa-ship', 'price': 4000, 'batch_size': 1, 'resources': {'wood': 8, 'iron': 140, 'bronze': 18}, 'required_tech': 'cruiser', 'required_tech_name': get_tech_name('cruiser')},
        'submarines': {'name': 'Подводные лодки', 'icon': 'fa-ship', 'price': 2500, 'batch_size': 1, 'resources': {'wood': 2, 'iron': 80, 'bronze': 10, 'cuprum': 5}, 'required_tech': 'submarine', 'required_tech_name': get_tech_name('submarine')}
    }
