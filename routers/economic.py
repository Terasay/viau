...
async def get_available_military_equipment():
    ...
    equipment_types = {
        ...
        'galleons': {'name': 'Галеоны', 'icon': 'fa-ship', 'price': 800, 'batch_size': 1, 'resources': {'wood': 120, 'iron': 10, 'bronze': 3}, 'required_tech': 'galleons', 'required_tech_name': get_tech_name('galleons')},
