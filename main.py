...
from routers import converter, maps, chat, registration, characters, settings, economic, tech, game_main, game_admin, statistics, provinces
...
app.include_router(game_main.router)
app.include_router(game_admin.router)
